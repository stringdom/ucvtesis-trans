...
científica de la transexualidad y el transgenerismo.
...
mismo del género hasta la autoimagen corporal.
...
debe tomar a la ligera. Como lo indica Lamas (1999), el emplear la palabra
...
sociales y culturales de la biología, pero esto probó ser complicado pues dio pie a que
...
Lo central de la definición es la \emph{conexión integral} entre dos ideas: el género
...
a que la socialización y la construcción de los géneros ha sido
...
Pero es John Money (c.p.~Butler, 2010), quien menciona la palabra género por
primera vez.
...
con bebés, condujo a este psiquiatra a utilizar el término “género” a partir de
...
discriminación en cuanto a lo que no se encuentra bajo la heteronorma\footnote{Cathy Cohen (2005) define la heteronormatividad como la práctica y
...
ubica a este discurso desde un puesto de poder de las ciencias básicas, lo que
implica que situar este discurso desde la ciencia tiene también una carga
política.
...
conductas, encubrimiento de discriminaciones, entre otros, y ahora tiene otras
...
\begin{quote}
    ...
    Esta condición remite a la mujer a una permanente incompletud y la
...
Es por esto que la American Psychological Association (APA) plantea que el uso de la
palabra \emph{Trans} es adecuado pues engloba a ambas identidades.
...
\section{Transgenerismo y transexualidad a lo largo de la historia}
...
Según Brissom (1973) en el mundo griego antiguo se cree que los “mitos de cambio
...
este aceptaba de forma favorable su nueva forma femenina, es repentinamente
...
como líderes dentro de un determinado movimiento social con énfasis en la
...
edición más reciente del Manual de diagnóstico de la APA lo que se conocía como
...
\subsection{Transgenerismo y transexualidad en Venezuela}
...
Planificación Familiar (PLAFAM) también posee un programa integral de atención
...
El mayor aporte de esta teoría radica en ofrecer nuevas explicaciones bajo un
...
Pero, aunque en sus inicios la teorización de lo Queer estaba para contribuir en la
...
control.
Es por eso, que esta propuesta teórica va más allá de la distinción sexo-género.
...
apariencia esta se encuentre en una esfera de lo privado.
...
para reivindicar la pluralidad, desde la postura del feminismo postmoderno, nos
...
este ha realizado la transición a una vida de tiempo completo con el sexo
...
formas que se supone podemos darles a los cuerpos para aproximarse al ideal, y
