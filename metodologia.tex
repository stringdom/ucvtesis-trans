...
En el caso de esta investigación los autores hemos decidido utilizar un enfoque
cualitativo, con una postura paradigmática de ontología relacional,
epistemología transaccional y metodología hermenéutica y dialecta, desde el
marco del estudio de casos. Los casos fueron seleccionados a través de un
muestreo intencional aprovechando las estrategias de bola de nieve para abordar
participantes con las características teóricas que requería la investigación.
Junto con los participantes se empleo una técnica de entrevista a profundidad
para construir la información que fue analizada mediante una codificación
abierta y una generalización teórica.

En este capítulo presentaremos estas decisiones que hemos tomado alrededor de la
metodología de la investigación así como la lógica y el razonamiento al que
responde cada una.
...
Nos haremos eco en su lugar de la crítica elaborada por Martínez Miguélez (2006)
  de que el uso de este término denota una postura radicalmente opuesta al
positivismo.
...
Lincoln, 2002, p. 128).
Este vínculo no es objetivo, o ajeno a la experiencia individual, sino que es
subjetivo.
...
Siguiendo entonces la propuesta de Heidegger (Ibíd.), la forma en la cual se puede uno aproximar a la
...
investigación al estudio de casos. Entenderemos el estudio de caso como un
abordaje empírico que investiga un fenómeno dentro de su contexto de la vida
real, especialmente cuando las fronteras entre fenómeno y contexto no son
claramente evidentes. Esta definición de Robert Yin (2011, p. 13) ilustra la
intencionalidad del estudio de casos y la manera en la que este se ajusta a la
visión epistemológica y metodológica propuesta por el paradigma
socio-construccionista y expuesta en los párrafos anteriores.
...
eventos, sucesos, comunidades, etc., sobre la cual se habrán de recolectar los
datos, sin que necesariamente sea representativa del universo o población que se
...
Por estos motivos utilizaremos en esta investigación el término de
...
participantes al universo de poblacional.
...
ciudad de Caracas que se identifiquen a sí mismas como transgénero.
...
participantes y la numeración asignada para identificarles en el capítulo
...
sobre cómo se deben realizar entrevistas en investigación de estudio de casos
...
neopositivista que propone una generalización estadística.

Este proceso de análisis está fundamentado en las propuestas del interaccionismo
interpretativo como es descrito por Denzin (c.p. Martínez Miguélez, 2006, p. 128),
...
observadores y múltiples teorías” (Ibíd.).
Es esta combinación de teorías anteriores y varias fuentes de información la
que permite alcanzar la ‘construcción mejor informada y más completa
...
refieren los códigos para entender dónde ubicar las categorías construidas.
...
Este paso es denominado por Strauss y Corbin (2002) como codificación axial.
...
La práctica de la psicología en el contexto venezolano es regida por un marco
legal sencillo.
...
Este contiene siete puntos a tener en cuenta cuando se hace investigación
con seres humanos.
...
aporte de una investigación para solventar un problema social.
...
En ese sentido consideramos que esta investigación posee relevancia social al ser
...
Bajo el término de validez científica agruparemos cuatro de los elementos del
...
Para ello la entrevista aporta una profundidad y complejidad que otros
...
establecer relaciones causales y diferenciarlas de relaciones espurias
(\emph{ibid.}).
...
Esta se refiere al establecimiento del dominio preciso al cual aplican las
...
demostración de que las operaciones del estudio pueden ser repetidas
...
Además, una observación de parte de entes independientes que velen por el uso
apropiado de la metodología de investigación.

Sobre estos dos puntos elaboraremos en las siguientes secciones sobre el marco
...
El informe de investigación desde la mirada de González Ávila (2002) debe ser
...
Una vez más, esperamos que este informe cumpla con estas características.
...
Los otros cuatro elementos de la bioética los agruparemos en esta sección
...
\begin{enumerate}
    \item Derecho a cambiar de opinión: de parte de los participantes.
